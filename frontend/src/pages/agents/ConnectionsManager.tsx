...
function Header({ isMobile, navigate }: { isMobile: boolean; navigate: (path: string) => void }) {
  return (
    <div
      style={{
    ...
    >
      ...
      <div>
        ...
        <p style={{ fontSize: 12, color: "var(--text-muted)", marginTop: 1 }}>Enable connections and configure API keys for mcp-secure-proxy</p>
      </div>
    </div>
  );
}
